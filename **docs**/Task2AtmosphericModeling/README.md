...
# Workflow for obtaining sparta data from NRLMSIS-00 model USING PREDICTOR:
...
# Workflow for obtaining sparta data from NRLMSIS-00 model USING HISTORICAL DATA ONLY:
  1. Download output_daily_updated (takes data from 1974-2026)
  2. Download and run gen_sparta_atm(3).py, make sure they are specficified in the directory
